...
export default function PricingInfo({ title, description, price, teamSize, support, updates }) {
    return (
        <>
            <div
                ...
                <ul role="list" className="mb-8 space-y-4 text-left">
                    ...
                    <li className="flex items-center space-x-3">
                        ...
                        <span>Team size: <span className="font-semibold">{teamSize} developer</span></span>
                    </li>
                    <li className="flex items-center space-x-3">
                        ...
                        <span>Premium support: <span className="font-semibold">{support} months</span></span>
                    </li>
                    <li className="flex items-center space-x-3">
                        ...
                        <span>Free updates: <span className="font-semibold">{updates} months</span></span>
                    </li>
                </ul>
                <a href="#"
